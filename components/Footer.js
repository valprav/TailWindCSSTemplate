    ...
    <footer className="bg-pink-500 text-white py-8">
      <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="flex md:justify-end space-x-6">
          <a href="#" className="text-white hover:text-yellow-200" aria-label="Twitter">
          ...
          <a href="#" className="text-white hover:text-yellow-200" aria-label="Facebook">
            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              <path d="M22 12A10 10 0 1012 22V14H9v-3h3V8a3 3 0 013-3h3v3h-3v3h3l-1 3h-2v8a10 10 0 008-10z" />
            </svg>
          </a>
          <a href="#" className="text-white hover:text-yellow-200" aria-label="Instagram">
            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
